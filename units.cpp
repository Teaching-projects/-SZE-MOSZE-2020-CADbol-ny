...
Unit::Unit(const std::string& name, int hp, int damage, float attackspeed) :m_name(name), m_hp(hp), m_damage(damage), m_xp(0), m_level(1), m_maxHP(m_hp), m_attackspeed(attackspeed) {}
