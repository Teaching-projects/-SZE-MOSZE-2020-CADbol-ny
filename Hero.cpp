...
Hero Hero::parse(const std::string& unitfilename){
	...
	values.get<int>("physical_damage_bonus_per_level"),values.get<int>("magical_damage_bonus_per_level"),values.get<int>("defense_bonus_per_level"),values.get<float>("cooldown_multiplier_per_level")
	);
}